...
public final class ValidationMessages {
    ...
    public static final String FIRST_NAME_MIN_LENGTH = "First name must be at least 2 characters";
    public static final String FIRST_NAME_MAX_LENGTH = "First name must be up to 100 characters";

    public static final String LAST_NAME_REQUIRED = "Last name is required";
    public static final String LAST_NAME_MIN_LENGTH = "Last name must be at least 2 characters";
    ...
    public static final String COUNTRY_MIN_LENGTH = "Country must be at least 2 characters";
    ...
    public static final String BIRTH_DATE_MIN_YEAR = "Birth date cannot be before 1900";

    public static final String COMPETITION_NAME_REQUIRED = "Competition name is required";
    public static final String COMPETITION_NAME_MIN_LENGTH = "Competition name must be at least 3 characters";
    ...
    public static final String MINIMUM_AGE_MAX = "Minimum age cannot exceed 100";
    ...
    public static final String MISSED_SHOTS_MAX = "Missed shots cannot exceed 100";
